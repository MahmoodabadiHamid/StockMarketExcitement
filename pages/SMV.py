...
# Read data from file
with open("FB_Index.txt") as file:
    data_str = file.read()
...
def update_chart(selected_years, selected_months, selected_days, show_percent_change, show_complete_data):
    ...
    print(filtered_df.sort_values(by='Time'))
    return fig
